...
export default function SupportWidget() {
    ...
    useEffect(() => {
        if (isLoaded && user) {
            setSavedEmail(user.primaryEmailAddress?.emailAddress || "");
        }
    }, [isLoaded, user]);
    ...
    }, [messages, view, isHidden]);

    // Move isHidden check here instead of early return
    const renderWidget = () => {
                            ...
                            <div className="p-3 bg-white border-t shrink-0">
                                ...
                                >
                                    <input
                                        ...
                                        placeholder={view === 'chat' ? "Type your question..." : "Ask anything..."}
                                        value={inputValue}
