...
### 1. PUBLIC SITE
https://resodin-public-prod.vercel.app/
...
### 2. ADMIN SITE  
https://resodinadmin-prod.vercel.app/admin
- [ ] Login screen loads with OTP form
- [ ] Enter: resodin.admin8153@protonmail.com
...
- [ ] Check inbox `resodin.admin8153@protonmail.com` for the test email.
